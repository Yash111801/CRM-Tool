...
router.post("/dashboard-column-chart-year", clientAuth, authorizeRole("ADMIN","CMT", "CRM"), async (req, res) => {
  await getDashboardColumnChartData(req, res);
});

router.post("/generate-report", clientAuth, authorizeRole("ADMIN","CMT", "CRM"), async (req, res) => {
